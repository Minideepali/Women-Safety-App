...
public class AddGuardian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_ET = findViewById(R.id.guardian_name);
        email_ET = findViewById(R.id.guardian_phone);
        ...
        loginBtn.setOnClickListener(view -> {
            Intent intent = new Intent(AddGuardian.this, LoginActivity.class);
            startActivity(intent);
        });

        registerBtn.setOnClickListener(view -> {
            utilService.hideKeyboard(view, AddGuardian.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            try {
                if (response.getBoolean("success")) {
                    ...
                    Toast.makeText(AddGuardian.this, token, Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(AddGuardian.this, MainActivity.class));
                }
            ...
            if (error instanceof ServerError && response != null) {
                try {
                    ...
                    Toast.makeText(AddGuardian.this, obj.getString("msg"), Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
